...
#define DEFAULT_SPEED_COEFFICIENT   16384 //  2^10 Default for SPEED_COEFFICIENT 1.0f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0].
...
// ################################# VARIANT_NUNCHUK SETTINGS ############################
  ...
  */
  ...
  #define SPEED_COEFFICIENT       8192    //  0.5f 2^10
...
// ########################### UART SETIINGS ############################
  ...
  #define SERIAL_BUFFER_SIZE      256                      // [bytes] Size of Serial Rx buffer. Make sure it is always larger than the structure size
